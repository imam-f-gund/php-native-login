...
<link rel="stylesheet" href="asset/css/resgister.css">
          ...
          <div class="card" style="border-radius: 15px;">
            <div class="card-body p-5">
              ...
              <form action='#' method="post">
                ...
                <div class="form-outline mb-4">
                  <input type="email" id="form3Example3cg" class="form-control form-control-lg" name="address" />
                  <label class="form-label" for="form3Example3cg">Your Address</label>
                </div> 
                
                <div class="form-outline mb-4">
                  <input type="email" id="form3Example3cg" placeholder="male/female"  class="form-control form-control-lg" name="gender"/>
